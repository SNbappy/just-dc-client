        ...
        >
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center mb-16">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/20 backdrop-blur-sm text-white font-semibold text-xs uppercase tracking-wider rounded-full mb-4">
                        <HiSparkles />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    {stats.map((stat, index) => (
                        ...
                        >
                            {/* Card */}
                            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                                {/* Icon */}
                                <div className="mb-6">
                                    <div className="inline-flex items-center justify-center w-16 h-16 bg-white/20 rounded-xl group-hover:scale-110 transition-transform">
                ...
                <div className="text-center mt-16">
                    ...
                    <button className="px-8 py-4 bg-white text-primary text-xl font-extrabold rounded-xl hover:bg-white/90 transition-all shadow-lg hover:shadow-xl">
